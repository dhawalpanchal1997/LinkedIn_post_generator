...
class FewShotPosts:
    def __init__(self, file_path=r"C:\Users\dhawa\OneDrive\Desktop\project\Linkedin post generator\Data\processed_posts.json"):
        self.df = None
...
if __name__ == "__main__":
    fs = FewShotPosts()
    # print(fs.get_tags())
    posts = fs.get_filtered_posts("Medium","English","Data Science")
    print(posts)